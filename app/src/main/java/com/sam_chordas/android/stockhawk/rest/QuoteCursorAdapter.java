...
public class QuoteCursorAdapter extends CursorRecyclerViewAdapter<QuoteCursorAdapter.ViewHolder>
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final Cursor cursor) {
        viewHolder.symbol.setText(cursor.getString(cursor.getColumnIndex(Constants.BundleConstants.SYMBOL)));
        viewHolder.symbol.setContentDescription(cursor.getString(cursor.getColumnIndex(Constants.BundleConstants.SYMBOL)));
        viewHolder.bidPrice.setText(AppUtils.truncateBidPrice(cursor.getString(cursor.getColumnIndex
                ("bid_price"))));
